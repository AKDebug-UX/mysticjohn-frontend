...
export default function AIChatPage() {
  ...
  if (isLoading) {
    return (
      <div className="flex-1 p-6 lg:p-8 pb-20 lg:pb-8 flex items-center justify-center">
  ...
  return (
    <>
          <main className="p-4 lg:p-8 pb-20 lg:pb-8 flex flex-col h-[calc(100vh-73px)] max-h-[calc(100vh-73px)]">
            {/* Header */}
