          ...
          <div className="container mx-auto px-4">
            {isLoading ? (
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-6xl mx-auto">
                {courses.map((course) => (
                  <Card key={course.id || course._id} className="border-border/50 pb-3 hover:border-primary/50 transition-all duration-300 hover:shadow-lg hover:shadow-primary/20 relative overflow-hidden flex flex-col">
