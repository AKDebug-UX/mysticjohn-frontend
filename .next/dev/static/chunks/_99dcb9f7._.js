...
const authApi = {
    register: async (data)=>{
        ...
        if (response.data) {
            __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiClient"].setToken(response.data.accessToken);
            if ("TURBOPACK compile-time truthy", 1) {
    ...
    login: async (data)=>{
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiClient"].post('/auth/login', data);
        if (response.data) {
            __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiClient"].setToken(response.data.accessToken);
            if ("TURBOPACK compile-time truthy", 1) {
                localStorage.setItem('refreshToken', response.data.refreshToken);
    ...
    logout: async ()=>{
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiClient"].setToken(null);
    },
    getMe: async ()=>{
    ...
    refreshToken: async ()=>{
        ...
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiClient"].post('/auth/refresh', {
            refreshToken
        });
        if (response.data) {
            __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiClient"].setToken(response.data.accessToken);
...
function AuthProvider({ children }) {
        ...
        "AuthProvider.useEffect": ()=>{
            ...
            const checkAuth = {
                "AuthProvider.useEffect.checkAuth": async ()=>{
                    const token = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiClient"].getToken();
                    if (token) {
                        try {
                            const userData = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$auth$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["authApi"].getMe();
                            setUser(userData);
                        } catch (error) {
                            // Token invalid, try refresh
                            const newToken = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$auth$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["authApi"].refreshToken();
                            if (newToken) {
                                try {
                                    const userData = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$auth$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["authApi"].getMe();
                                    setUser(userData);
    ...
    const register = async (email, password, name)=>{
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$auth$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["authApi"].register({
            email,
            password,
            name
        });
...
//# sourceMappingURL=_99dcb9f7._.js.map